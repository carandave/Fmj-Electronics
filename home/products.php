                                        ...
                                        <div class="col-md-12">
                                            <form id="add-form">
                                                    ...
                                                    <select name="category_id" id="category-dropdown" class="form-control">
                                                        ...
                                                        <?php if($resultc->num_rows > 0){?>
                                                            <?php while($rowc = $resultc->fetch_assoc()){?>
                                                                <option value="<?php echo $rowc['category_Id']?>" class="font-weight-bold" style="font-size:18px;"><?php echo $rowc['category_Id']?> <?php echo $rowc['category_Name']?></option>
                                                            <?php } ?>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <select name="produt_type_id" id="product-type-dropdown" class="form-control">
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <select name="type_id" id="type-dropdown" class="form-control">
